...
export const StaggeredMenu: React.FC<StaggeredMenuProps> = ({
  ...
  const buildOpenTimeline = useCallback(() => {
    ...
    if (overlay) {
      tl.to(overlay, { opacity: 1, duration: 0.4, ease: 'power2.out', pointerEvents: 'auto' }, 0);
    }
  ...
  return (
    ...
    >
      ...
      >
        <div 
          ref={overlayRef} 
          className="fixed inset-0 z-0 bg-black/40 backdrop-blur-md opacity-0 pointer-events-none" 
          aria-hidden="true" 
        />
        <div
          ref={preLayersRef}
        ...
        >
          ...
          <button
            ref={toggleBtnRef}
            className="sm-toggle relative inline-flex items-center gap-[0.3rem] bg-[#faf9f5] hover:bg-white px-6 py-3 rounded-full shadow-lg cursor-pointer font-mono text-[12px] uppercase tracking-tight leading-none overflow-visible pointer-events-auto transition-colors text-[#141413]"
            style={{ color: '#141413' }} // Force color override to prevent GSAP from making it unreadable
        ...
        >
          ...
          <div className="sm-panel-inner relative z-10 flex-1 flex flex-col gap-5">
            <ul
...
.sm-scope .sm-prelayer { position: absolute; top: 0; right: 0; height: 100%; width: 100%; opacity: 0; }
