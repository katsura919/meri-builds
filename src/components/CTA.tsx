...
export function CTA() {
  return (
    <section id="contact" className="relative py-32 px-6 flex flex-col items-center justify-center min-h-[80vh] border-t-4 border-brand-black bg-[#faf9f5] text-[#141413]">
      ...
      <div className="relative z-10 max-w-[1200px] w-full flex flex-col items-center gap-16 text-center">
        ...
        <Link 
          ...
          target="_blank"
          className="group bg-brand-black text-[#faf9f5] rounded-full px-16 py-6 md:px-24 md:py-8 font-mono text-xl md:text-2xl uppercase tracking-tighter hover:scale-110 transition-transform duration-300 ease-in-out inline-flex items-center gap-4"
        >
          Message Me
          <span className="bg-brand-orange text-brand-black rounded-full p-1 group-hover:rotate-45 transition-transform duration-300">
